		...
		<view class="uni-padding-wrap">
			<form @submit="formSubmit" @reset="formReset">
				...
				<view>
					...
					<view class="uni-list">
						<view class="uni-list-cell">
							<input class="uni-input" name="foundLocation" placeholder="请填写捡到物品的位置" />
						</view>
					</view>
				</view>
				<view>
					...
					<view class="uni-textarea" auto-height>
						<textarea name="articleDesc" placeholder="请填写物品描述"/>
					</view>
				</view>
				...
				<view>
					...
					<view class="uni-list">
						<view class="uni-list-cell">
							<input class="uni-input" name="contactsName" placeholder="请填写联系人姓名" />
						</view>
					</view>
				</view>
				<view>
					...
					<view class="uni-list">
						<view class="uni-list-cell">
							<input class="uni-input" name="contactsPhone" placeholder="请填写联系电话" />
						</view>
					</view>
				</view>
